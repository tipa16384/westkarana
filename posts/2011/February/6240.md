...
---
**Brian 'Psychochild' Green** writes: Yeah, it probably would have been better if you could have done a quest to get the compass instead of just relying on random drops.  I guess you could have farmed enough doubloons eventually.  But, yeah, it does kind of suck that the easy answer is "spend some money" rather than balancing things out properly.  But, once past that hurdle it <i>was</i> a pretty neat scenario.
---
