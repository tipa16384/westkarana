...
---
**Tipa** writes: sed -- <b>s</b>treaming <b>ed</b>itor was more of a Unix thing, because if you couldn't make all the edits you need with one mega regular expression and a pipe, then it wasn't worth doing.\r\n\r\nAnyway, I'm not the greatest at sed, but ...\r\n\r\nsed -e {s/Estendil/Esteldin/} -e {s/Evendrim/Evendim/}\r\n\r\nwould have done it. I'm positive it could be done in half the characters.
---
