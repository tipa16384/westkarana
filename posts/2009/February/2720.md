...
**syncaine** writes: So the combat is not turn based like the good Atlus games?

That above screen looks painful btw... PS1 graphics?

---

**Tipa** writes: Screenshots just show standard F2P MMO-fare.
...
**Sente** writes: That does certainly not look steampunk:ish. If that is steampunk, then even WoW could be called steampunk - there are techie gnome stuff in that game, after all.
...
**Tesh** writes: Sorry for the double post, but I'm looking forward to Gatheryn for steampunk. Whether or not it's done well, I'm not sure, but at least someone else is trying.

---

**Tipa** writes: Gatheryn? Huh, not heard of it.
...
**West Karana » Gatheryn &#8212; is this the Steampunk game for the rest of us?** writes: [...] I wrote about “Neo Steam”, which brings a decidedly Eastern, hardcore PvP, flair to that eternal conflict between technology [...]
...
**Tipa** writes: Cool, thanks for the hands-on about the game! I've joined up with Atlus Online, and I'm hoping to be able to check out the beta when it happens so I can speak about the game with a little bit of experience with it.
