...
---
**Tipa** writes: @Ryan -- Shards of Dalaya?\r\n\r\n@Egat -- stop by sometime :) Guild hall is toasty warm and Buddy the Giant Dog hardly eats anyone any more.
---
**Ryan** writes: Nope. I play on PEQ. Though I've heard SoD is good, it is too "custom" for me to get into. EQ is a comfort </strike> food</strike> game.
---
**Tipa** writes: PEQ? Hmm... never heard of that one. It's like old EQ? How old?
---
**Tipa** writes: Oh, Project EQ? (Looked it up). I have station pass so I can just play EQ Live whenever, or is Project EQ a date-capped version of EQ Live? Since they have Shadowrest, that implies at least Planes of Power...
---
