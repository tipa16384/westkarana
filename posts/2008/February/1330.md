...
## Comments!
---
**stargrace** writes: As an extra bonus by the way for the crafting epics - when you complete them (or one of the steps close to completion, not sure which yet) you get 1 of every T8 rare there is. Yup, that's right, one of each. As well as the clock, and the earing. 
...
---
**Openedge1** writes: Wow...ok...this looks really neat. The crafting was already some of the best in any MMO, but now "epics"...awesome...
