...
**stargrace** writes: Hey, have you been to the instance in Chardok yet? You need access to get in (drop from bridge keeper) and you need the sokokar post (to make things easy) But -- the best thing is it's VERY simple, and only on a 5 hour lock out timer. Those aa mirror shards also drop fairly frequently (2 legendary 1 master 1 mirror every run so far, not bad for a 5 hour lock out). Think it's called Korocust or something close to that (not sure if it was apart of EQ1 but I imagine so.. my memory isn't as great as yours!).

---

**ongarr** writes: are you going to make another character once all of your current ones hit 80?

---

**Tipa** writes: I have plenty of characters. My next lowest is my 66 necro/70 jeweler, Dorah. She's going to become an 80 jeweler and I may level her some. I still have a lot of gear to get for Dina and Dera so I expect plenty of instance runs in the future anyway.
...
**Tipa** writes: Fare! ***hug*** miss you, hope things are going well on Blackburrow. Zerith is back, he's still wearing the Revolution tag, too.
