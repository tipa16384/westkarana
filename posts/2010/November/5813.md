...
**Tipa** writes: Hard to think of anything that hasn't been said there, except that if DDO were a subscription game, I would not be playing it.
...
**Tipa** writes: Since this is soloable and a little frustrating for four people to coordinate, maybe we ought to just skip it -- people can solo it if they want. A togue is not required but I'd be willing to come along whenever. 
