...
---
**Tipa** writes: <code>\r\n&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;spot.getScent()&nbsp;&gt;&nbsp;0:<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#print&nbsp;"on&nbsp;the&nbsp;trail",self<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bestSmell&nbsp;=&nbsp;spot.getScent()<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bestFace&nbsp;=&nbsp;None<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for&nbsp;f&nbsp;in&nbsp;ALLDIRS:<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;self.canMove(f,board,group):<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;npos&nbsp;=&nbsp;board.getAt(self.newPos[0],self.newPos[1])<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;npos.getScent()&nbsp;&gt;&nbsp;bestSmell:<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bestFace&nbsp;=&nbsp;f<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bestSmell&nbsp;=&nbsp;npos.getScent()<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;bestFace&nbsp;is&nbsp;not&nbsp;None:<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;choices&nbsp;=&nbsp;[bestFace]<br>\r\n</code>\r\n
---
